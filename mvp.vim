...
wincmd w
argglobal
if bufexists("~/product/lightweight-charts/src/index.ts") | buffer ~/product/lightweight-charts/src/index.ts | else | edit ~/product/lightweight-charts/src/index.ts | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe '2resize ' . ((&lines * 22 + 24) / 48)
tabnext
edit ~/product/lightweight-charts/src/gui/chart-widget.ts
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 42 - ((22 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
42
...
wincmd w
argglobal
if bufexists("~/product/lightweight-charts/src/api/iseries-api.ts") | buffer ~/product/lightweight-charts/src/api/iseries-api.ts | else | edit ~/product/lightweight-charts/src/api/iseries-api.ts | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 51 - ((9 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
51
...
exe '2resize ' . ((&lines * 21 + 24) / 48)
tabnext
edit ~/product/lightweight-charts/src/api/iseries-api.ts
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 65 - ((39 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
65
...
badd +9 ~/product/lightweight-charts/chart.html
badd +0 ~/product/lightweight-charts/chart.css
