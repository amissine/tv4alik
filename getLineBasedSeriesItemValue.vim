...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 48 - ((41 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
48
...
tabnext
edit ~/product/lightweight-charts/src/renderers/walk-line.ts
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
tabnext 1
set stal=1
badd +102 ~/product/lightweight-charts/src/api/data-layer.ts
badd +43 ~/product/lightweight-charts/src/renderers/line-renderer.ts
