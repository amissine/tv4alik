...
argglobal
%argdel
$argadd src/model/series.ts
edit src/api/chart-api.ts
...
silent! normal! zE
let s:l = 72 - ((19 * winheight(0) + 11) / 23)
...
wincmd w
argglobal
if bufexists("~/product/lightweight-charts/src/model/time-data.ts") | buffer ~/product/lightweight-charts/src/model/time-data.ts | else | edit ~/product/lightweight-charts/src/model/time-data.ts | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe '2resize ' . ((&lines * 22 + 24) / 48)
tabnext 1
badd +0 ~/product/lightweight-charts/src/model/series.ts
badd +7 ~/product/lightweight-charts/src/model/time-data.ts
badd +0 ~/product/lightweight-charts/src/api/chart-api.ts
