...
wincmd w
argglobal
if bufexists("~/product/lightweight-charts/tsconfig.base.json") | buffer ~/product/lightweight-charts/tsconfig.base.json | else | edit ~/product/lightweight-charts/tsconfig.base.json | endif
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
if bufexists("~/product/lightweight-charts/tsconfig.json") | buffer ~/product/lightweight-charts/tsconfig.json | else | edit ~/product/lightweight-charts/tsconfig.json | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("~/product/lightweight-charts/package.json") | buffer ~/product/lightweight-charts/package.json | else | edit ~/product/lightweight-charts/package.json | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("~/product/lightweight-charts/src/api/create-chart.ts") | buffer ~/product/lightweight-charts/src/api/create-chart.ts | else | edit ~/product/lightweight-charts/src/api/create-chart.ts | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("~/product/lightweight-charts/src/model/chart-model.ts") | buffer ~/product/lightweight-charts/src/model/chart-model.ts | else | edit ~/product/lightweight-charts/src/model/chart-model.ts | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("~/product/lightweight-charts/src/gui/chart-widget.ts") | buffer ~/product/lightweight-charts/src/gui/chart-widget.ts | else | edit ~/product/lightweight-charts/src/gui/chart-widget.ts | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 415 - ((9 * winheight(0) + 5) / 10)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
415
